...
const getAll = function() {
  return new Promise(function (resolve) {
    let result = [];
    result.push(new Resource({id: "1", displayName:"It Doesn't Have to be Crazy at Work", imageUrl:"https://uploads-ssl.webflow.com/5c7b3cd55c229322e94ab73d/6401aaec465a8fd8efb3e0a4_crazy.jpg", category: "Book", authors: ["Jason Fried", "David Heinemeier Hansson"]}))
    ...
    result.push(new Resource({id: "7", parentResourceId: "9", parentResourceName:"Lenny's Podcast", displayName:"Show about somethinh on Lenny's Podcast", description:"deswede sdfsdf s sdf s", category: "Podcast Episode", imageUrl: "https://images.podpage.com/https%3A%2F%2Fsubstackcdn.com%2Ffeed%2Fpodcast%2F10845%2Fpost%2F113964811%2F89db3aa60e2500f8da945a0f0839558d.jpg?auto=format&dpr=2&q=50&w=600&s=42880fbb79c4b4394e6ba9f9b9cce489", authors: ["Lenny"]}))
    ...
    result.push(new Resource({d: "10", displayName:"Tom's Podcast", imageUrl:"https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQN1t2TQiVAh5QyrpJXQYIdrJsaOI8GRGsuDJFMiw9ZCA0P4Us-", description:"This is a podcast...", category: "Podcast", authors: ["Lenny"]}))
    result.push(new Resource({d: "11", displayName:"Sam Harris", imageUrl:"https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQN1t2TQiVAh5QyrpJXQYIdrJsaOI8GRGsuDJFMiw9ZCA0P4Us-", description:"This is a podcast...", category: "Podcast", authors: ["Lenny"]}))
    result.push(new Resource({d: "12", publishedDate: new Date(), displayName:"Lenny's Podcast", imageUrl:"https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQN1t2TQiVAh5QyrpJXQYIdrJsaOI8GRGsuDJFMiw9ZCA0P4Us-", description:"This is a podcast...", category: "Podcast", authors: ["Lenny"]}))
    resolve(result)
  });
}
