...
const searchResources = function(searchTerm) {
  return new Promise(function (resolve) {
    ...
    if (searchTerm == "s") {
      ...
      result.push(new Resource({id: "6", displayName:"How to build a cult-like brand | Laura Modi (Bobbie)", description:"Interviews with world-class product leaders and growth experts to uncover concrete, actionable, and tactical advice to help you build, launch, and grow your own product.", imageUrl:"https://images.podpage.com/https%3A%2F%2Fsubstackcdn.com%2Ffeed%2Fpodcast%2F10845%2Fpost%2F113964811%2F89db3aa60e2500f8da945a0f0839558d.jpg?auto=format&dpr=2&q=50&w=600&s=42880fbb79c4b4394e6ba9f9b9cce489", category: "Podcast", authors: ["Lenny"]}))
      result.push(new Resource({id: "6", displayName:"Lenny's Podcast", description:"", category: "Podcast", authors: ["Lenny"]}))
    }
    resolve(result)
  });
}
