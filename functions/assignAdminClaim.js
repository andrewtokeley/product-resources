 ...
 * 2. Copy the user's UID into the assignAdminClaim function at the
 * end of this file
 * 3. Re-deploy the app
 * 4. Create a new firestore collection called "tempoAssignClaim"
 * 5  Create a security rule to prevent both read and write to this table
 * - don't want anyone being able to give themselves admin rights!
 * 5. From console, create a new document in the collection with id equal
 * to the users UID.
 ...
 * The document id will be assumed to be the uid of the user to be made admin.
 * Firestore security rules prevent anyone from reading/writing to this table,
 * only project admins can do this (and cloud function's of course)
 */
